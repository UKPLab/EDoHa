...
if "__main__"==__name__:
    ...
    train_links = data[["topic", "candidate"]].values
    train_labels = data["label"].values == "link"
    ...
    # with open("../models/hypothesisevidencelinking-demo.json", "w") as json_file:
    #     json_file.write(model_json)
    # # serialize weights to HDF5
    # model.save("../models/hypothesisevidencelinking-demo.h5")
